  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\250\007\000\000\200\000\000\000"
      }
    }
  }
}
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\377\377\377\377\250\007\000\000"
      }
    }
  }
}
...
node {
  name: "gradients/conv2d1_grad/ShapeN"
  op: "ShapeN"
  input: "Reshape"
  input: "w_conv1/read"
  attr {
...
node {
  ...
  input: "gradients/conv2d1_grad/ShapeN"
  input: "w_conv1/read"
...
node {
  ...
  input: "Reshape"
  input: "gradients/conv2d1_grad/ShapeN:1"
  input: "gradients/add_grad/tuple/control_dependency"
  attr {
    key: "T"
    value {
