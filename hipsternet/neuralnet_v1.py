...
class ConvNet(NeuralNet):
    ...
    def _init_model(self, D, C, H):
        self.model = dict(
            W1=np.load("D:/Python/Python36/MNIST_CNN/weight/hipsternet/W_conv1.npy"),
            W2=np.load("D:/Python/Python36/MNIST_CNN/weight/hipsternet/W_fc1.npy"),
            W3=np.load("D:/Python/Python36/MNIST_CNN/weight/hipsternet/W_fc2.npy"),
            b1=np.load("D:/Python/Python36/MNIST_CNN/weight/hipsternet/b_conv1.npy"),
            b2=np.load("D:/Python/Python36/MNIST_CNN/weight/hipsternet/b_fc1.npy"),
            b3=np.load("D:/Python/Python36/MNIST_CNN/weight/hipsternet/b_fc2.npy")
        )
